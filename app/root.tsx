 ...
 * per-page descriptors like `<title>` remain owned by each route.
 */
 ...
 * in development when navigating between pages.
 */
...
export function ErrorBoundary() {
  ...
  // For non-route errors, show a generic error
  const genericError = {
    status: 500,
  ...
  return <RouteErrorBoundary error={genericError} />;
}
